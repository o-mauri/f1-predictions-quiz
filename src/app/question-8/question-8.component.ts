...
export class Question8Component {
  ...
  readonly answers: Question8Answer[] = [
    ...
    { player: players.jazz,    race1: Races.monaco,     race2: Races.abuDhabi,     text1: "+15", red1: 1, sc1: 2, vsc1: 0, text2: "", red2: 0, sc2: 0, vsc2: 0 },
    ...
    { player: players.michael, race1: Races.monaco,     race2: Races.belgium,      text1: "+15", red1: 1, sc1: 2, vsc1: 0, text2: "", red2: 0, sc2: 0, vsc2: 0 },
    { player: players.koli,    race1: Races.monaco,     race2: Races.belgium,      text1: "+15", red1: 1, sc1: 2, vsc1: 0, text2: "", red2: 0, sc2: 0, vsc2: 0 },
  ];
}
