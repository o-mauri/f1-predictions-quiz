...
export class Question6Component {
  ...
  podiumDrivers: Driver[] = [Drivers.georgeRussell, Drivers.kimiAntonelli, Drivers.charlesLeclerc, Drivers.lewisHamilton, Drivers.oscarPiastri, Drivers.landoNorris];
