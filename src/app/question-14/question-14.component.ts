...
export class Question14Component {
  ...
  results: Question14Result = {
    mercedesStat1: '2',
    mercedesStat2: '1',
    mercedesWinner: Drivers.georgeRussell,
    ferrariStat1: '0',
    ferrariStat2: '2',
    ferrariWinner: Drivers.charlesLeclerc,
    redBullStat1: '55',
    redBullStat2: '34 (62%)',
    redBullWinner: Drivers.isackHadjar,
    mclarenStat1: '0',
    mclarenStat2: '0',
    mclarenWinner: null,
    alpineStat1: '3rd',
    alpineStat2: '6th',
    alpineWinner: Drivers.pierreGasly,
    haasStat1: '3',
    haasStat2: '2',
    haasWinner: Drivers.oliverBearman,
    racingBullsStat1: '382',
    racingBullsStat2: '364',
    racingBullsWinner: Drivers.liamLawson,
    astonMartinStat1: '0',
    astonMartinStat2: '0',
    astonMartinWinner: null,
    williamsStat1: '6',
    williamsStat2: '5',
    williamsWinner: Drivers.carlosSainz,
    cadillacStat1: '5',
    cadillacStat2: '2',
    cadillacWinner: Drivers.sergioPerez,
    audiStat1: '0',
    audiStat2: '0',
    audiWinner: null,
  };
